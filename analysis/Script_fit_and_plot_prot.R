...
PREFIX="dmpg"
# long prefix name
LONG_PREFIX=paste("Total_Up_",PREFIX,sep="")
...
# Open a pdf device
pdf(paste("Res_prot_",PREFIX,"Up_",DIST_GROUP,".pdf",sep=""))
...
sink(paste("Res_prot_",PREFIX,"Up_",DIST_GROUP,".txt",sep=""))
...
# load PackMem data
####
filename=paste(LONG_PREFIX,"_",DEFECT,"_prot.txt",sep="")
packdef_data_full=read.table(filename, sep=",")

# For all defects
#packdef_data=packdef_data_full[, 3]
# For a given distance group
packdef_data=packdef_data_full[which(packdef_data_full[, 2] == DIST_GROUP), 3]
...
print(paste("Results on",PREFIX,"for",DEFECT,"defects at",DIST_GROUP,"distance."))
